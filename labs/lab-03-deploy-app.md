...
> **💡 AGB Cloud Users:** If `EXTERNAL-IP` stays `<pending>`, use the **Public IP** provided by the facilitator and ensure your AGB Cloud Port Forwarding rule points to the **NodePort 30706**.
>
